...
public final class CameraUtils {
    ...
    public static Size getPictureSize(List<Size> choices, @CameraConfig.MediaQuality int mediaQuality) {
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public static Size getPictureSize(Size[] sizes, @CameraConfig.MediaQuality int mediaQuality) {
