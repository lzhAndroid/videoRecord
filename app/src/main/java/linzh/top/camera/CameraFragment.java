...
import linzh.top.camera.config.model.Camera;
import linzh.top.camera.config.model.Flash;
import linzh.top.camera.config.model.MediaAction;
import linzh.top.camera.config.model.Record;
import linzh.top.camera.config.CameraConfig;
import linzh.top.camera.config.CameraConfigProvider;
import linzh.top.camera.config.CameraConfigProviderImpl;
import linzh.top.camera.config.PictureQualityOption;
import linzh.top.camera.config.VideoQualityOption;
import linzh.top.camera.lifecycle.CameraLifecycle;
import linzh.top.camera.lifecycle.impl.Camera1Lifecycle;
import linzh.top.camera.lifecycle.impl.Camera2Lifecycle;
import linzh.top.camera.lifecycle.listener.CameraView;
import linzh.top.camera.listener.CameraControlListener;
import linzh.top.camera.listener.CameraStateListener;
import linzh.top.camera.listener.CameraVideoRecordTextListener;
import linzh.top.camera.listener.ICameraFragment;
import linzh.top.camera.listener.OnCameraResultListener;
import linzh.top.camera.util.CameraUtils;
import linzh.top.camera.util.Size;
import linzh.top.camera.util.DeviceUtils;
import linzh.top.camera.util.timer.CountdownTask;
import linzh.top.camera.util.timer.TimerTask;
import linzh.top.camera.util.timer.TimerTaskBase;
import linzh.top.camera.widget.AutoFitFrameLayout;

import java.io.File;

import linzh.top.app.R;
...
public class CameraFragment<CameraId> extends Fragment implements ICameraFragment {
    ...
    private int mNewQuality = CameraConfig.MEDIA_QUALITY_AUTO;
